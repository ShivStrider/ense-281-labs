...
// Author: Shivam Soni
//
// This script populates the MongoDB database with the starter
// users and posts from Lab 7 (users.json and posts.json).
//
// Usage:  node seed.js
...
async function seed() {
    try {
        ...
        // --------------------------------------------------------
        // Step 2: Create starter users (from users.json)
        // --------------------------------------------------------
